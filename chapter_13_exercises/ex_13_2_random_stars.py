...
from ex_13_2_settings import Settings
from ex_13_2_star import Star
...
class StarsGrid:
    ...
    def _create_star_grid(self):
        ...
        # Spacing between each star is random.
        star = Star(self)
    ...
    def _create_star(self, star_number, row_number):
        ...
        star.x += randint(0, star_width)
        star.rect.x = star.x
        star.rect.y = star_height + 2 * star_height * row_number
        star.rect.y += randint(0, star_height)
        self.stars.add(star)
